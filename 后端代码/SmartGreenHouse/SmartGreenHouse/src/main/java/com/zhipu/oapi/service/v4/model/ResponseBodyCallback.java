...
public class ResponseBodyCallback implements Callback<ResponseBody> {
    ...
    private FlowableEmitter<com.zhipu.oapi.service.v4.model.SSE> emitter;
    private boolean emitDone;

    public ResponseBodyCallback(FlowableEmitter<com.zhipu.oapi.service.v4.model.SSE> emitter, boolean emitDone) {
        ...
        try {
            if (!response.isSuccessful()) {
                ...
                if (errorBody == null) {
                    ...
                    com.zhipu.oapi.service.v4.model.ZhiPuAiError error = mapper.readValue(
                            errorBody.string(),
                            ZhiPuAiError.class
                    );
            ...
            String line;
            com.zhipu.oapi.service.v4.model.SSE sse = null;
