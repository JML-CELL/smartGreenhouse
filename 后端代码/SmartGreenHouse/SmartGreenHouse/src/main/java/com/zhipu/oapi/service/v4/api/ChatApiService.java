...
public class ChatApiService {
    ...
    private final com.zhipu.oapi.service.v4.api.ChatApi api;
    ...
    public ChatApiService(final String token, final Duration timeout) {
        ...
        this.api = retrofit.create(com.zhipu.oapi.service.v4.api.ChatApi.class);
     ...
     */
    public ChatApiService(final com.zhipu.oapi.service.v4.api.ChatApi api) {
        this.api = api;
